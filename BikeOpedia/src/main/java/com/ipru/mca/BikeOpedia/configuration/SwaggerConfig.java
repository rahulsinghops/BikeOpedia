...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo apiInfo = new ApiInfo("BikeOpedia", "Directory of bikes as per given criteria", "V_1.1", "Free to use", new Contact("rahul singh", "www.bikeguru.com", "siingh.rahul@gmail.com"), "RS Licence", "www.bikeguru.com",Collections.emptyList());
		return apiInfo;
	}
